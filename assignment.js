 ...
 *
 * Note: when you uncomment and refresh, both the piece preview and the current
 * active piece will stop showing up. Like the random boolean for centering,
 * this is due to the "false-y" nature of 'undefined', since isAt also returns
 * a boolean value. If you wait a few seconds, once the pieces land at the
 * bottom of the board they WILL show up.
 */
